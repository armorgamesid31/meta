...
router.post('/slots', async (req: any, res: any) => {
  try {
    ...
    // NOT: Eski "OFF_PEAK slot etiketleme" (offPeakLabel) KALDIRILDI — slot grid
    // artık indirim rengi/etiketi göstermiyor (renk = uzman tercihi), tüm indirim
    // iletişimi sepet altında. İndirimin kendisi previewCampaignPricing'de uygulanır;
    // burada her istekte bir kampanya DB sorgusu yapmak gereksizdi.

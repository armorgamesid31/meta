  ...
  return (
    <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
      ...
      <button
        ...
        className="flex-1 min-w-[160px] bg-white rounded-[20px] p-4 shadow-sm hover:shadow-md transition-shadow border border-gray-100"
        aria-label="Son işlemi tekrarla"
      >
      ...
      <button
        ...
        className="flex-1 min-w-[160px] bg-white rounded-[20px] p-4 shadow-sm hover:shadow-md transition-shadow border border-gray-100 relative"
        aria-label="Paketlerim"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="text-left">
            <p className="text-sm font-medium text-[#2D2D2D] mb-1">Paketlerim</p>

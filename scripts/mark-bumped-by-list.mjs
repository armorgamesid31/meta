...
const BUMPED_NAMES = [...new Set([
  'kedy_google_maps_yorum_b1',
  'kedy_google_maps_yorum_b2',
  'kedy_google_maps_yorum_b3',
  'kedy_google_maps_yorum_b4',
  'kedy_google_maps_yorum_f1',
  'kedy_google_maps_yorum_f2',
  'kedy_google_maps_yorum_f3',
  'kedy_google_maps_yorum_f4',
  'kedy_memnuniyet_anketi_f2',
  'kedy_waitlist_teklif_b1',
  'kedy_waitlist_teklif_b3',
  'kedy_waitlist_teklif_b4',
  'kedy_waitlist_teklif_f1',
  'kedy_waitlist_teklif_f2',
  'kedy_waitlist_teklif_f3',
  'kedy_waitlist_teklif_f4',
  'kedy_waitlist_teklif_f5',
  'kedy_randevu_hatirlatma_2_saat_f2',
])];
